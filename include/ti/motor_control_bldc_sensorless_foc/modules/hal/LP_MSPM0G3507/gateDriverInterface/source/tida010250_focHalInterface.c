...
#ifndef PHASE_VOLTAGE_SENSE_DISABLED
...
{
        int32_t adc1Idx0,adc1Idx1,adc1Idx2;
       ...
       CURRENT_SHUNT_TYPES currentShunt = pCurrent->currentShunt;
        ...
        adc1Idx1 = DL_ADC12_getMemResult(FOC_ADC1_INST, ADC1_IDX_1);
        adc1Idx2 = DL_ADC12_getMemResult(FOC_ADC1_INST, ADC1_IDX_2);
...
void HAL_GD_ConfigureCurrentChannels(CURRENT_SHUNT_TYPES currentShunt)
{
    ...
    switch(currentShunt)
    {
       ...
       case CURRENT_THREE_SHUNT_AB_C:
       case CURRENT_THREE_SHUNT_A_BC:
           HAL_setADCIdxChannel(FOC_ADC1_INST, ADC1_IDX_0, ADC1_CURRENT_U_CH);
           HAL_setADCIdxChannel(FOC_ADC1_INST, ADC1_IDX_1, ADC1_CURRENT_V_CH);
           HAL_setADCIdxChannel(FOC_ADC1_INST, ADC1_IDX_2, ADC1_CURRENT_W_CH);
           break;
       ...
       case CURRENT_TWO_SHUNT_A_C:
           HAL_setADCIdxChannel(FOC_ADC1_INST, ADC1_IDX_0, ADC1_CURRENT_U_CH);
           HAL_setADCIdxChannel(FOC_ADC1_INST, ADC1_IDX_1, ADC1_CURRENT_W_CH);
           break;

       case CURRENT_TWO_SHUNT_B_C:
           HAL_setADCIdxChannel(FOC_ADC1_INST, ADC1_IDX_0, ADC1_CURRENT_V_CH);
           HAL_setADCIdxChannel(FOC_ADC1_INST, ADC1_IDX_1, ADC1_CURRENT_W_CH);
           break;
